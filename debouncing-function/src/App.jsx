...
import debounce from "./function/debouncing";
...
function App() {
  ...
  const passSearch = debounce(passwordChange, 500);
  ...
  return (
    <div className="bg-gray-300 w-screen h-screen">
      <div className="flex w-full flex-col p-10 items-center">
        ...
        {error ? (
          <button type="submit" className="bg-white px-5">
            Save Password
          </button>
        ) : (
